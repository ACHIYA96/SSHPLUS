...
echo -e 'By: @MEGALODON_SSH> /etc/rec/licence
echo -e 'By: @MEGALODON_SSH> /usr/lib/licence
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@MEGALODON_SSH\033[0m"
